...
: ${AMENT_CURRENT_PREFIX:="/home/bo/go2_ws_toolbox/install/go2_core"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_core/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/go2_core/environment/path.sh"
